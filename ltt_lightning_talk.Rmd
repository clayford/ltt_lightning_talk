...
>- You can use Zoom breakout rooms, but should you? Hot take: I don't think so.
>- Consider doing exercises together as a class instead of pausing for independent exercises. 
>- Create a pre-workshop checklist and use it. [Here's my checklist](https://github.com/clayford/workshop_checklist/blob/main/README.md)
>- Start a little late if you want, but end on time. And it's OK to end early.
